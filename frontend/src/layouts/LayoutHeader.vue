  ...
  <header class="bg-primary-900 border-primary-700">
    <div class="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24">
          ...
          <ul class="flex gap-6">
            <li>
              <router-link to="/coaches"
                ...
                active-class="!font-bold !leading-[120%] !border-secondary-800 !text-primary-0">尋找教練</router-link>
            </li>
            <li>
              <router-link to="/fitness-plans"
                class="text-neutral-300 hover:text-primary-0 transition-all font-medium text-base leading-[150%] pb-1 border-b-2 border-transparent"
                active-class="!font-bold !leading-[120%] !border-secondary-800 !text-primary-0">健身方案</router-link>
            </li>
          </ul>
        </nav>

        <div class="hidden md:flex items-center gap-6">
          <router-link v-if="!name" to="/login"
            class="bg-secondary-800 hover:bg-secondary-700 text-primary-900 font-medium text-base leading-[150%] px-5 py-3 rounded transition-colors h-12 flex items-center justify-center">立即加入</router-link>
          <p v-if="name" class="font-bold text-primary-0">
            歡迎，{{ name }}您好！
          </p>
          <router-link v-if="role === 'USER'" to="/user/dashboard"
          ...
          <router-link v-if="role === 'COACH'" to="/coach/profile"
            class="bg-secondary-800 hover:bg-secondary-700 text-primary-900 font-medium text-base leading-[150%] px-5 py-3 rounded transition-colors h-12 flex items-center justify-center">
            教練介面
          </router-link>
          <router-link v-if="name" to="/" @click="logout"
      ...
      <transition enter-active-class="transition-all duration-300 ease-out overflow-hidden"
        leave-active-class="transition-all duration-200 ease-in overflow-hidden" enter-from-class="max-h-0 opacity-0"
        ...
        <nav v-if="isMobileMenuOpen"
          ...
          <ul class="flex flex-col gap-3 px-4">
            ...
            <li>
              <router-link to="/coaches" @click="closeMobileMenu"
            ...
            <li>
              <router-link to="/fitness-plans" @click="closeMobileMenu"
                class="inline-block py-2 text-neutral-300 hover:text-primary-0 transition-all font-medium text-base leading-[150%] border-b-2 border-transparent"
                active-class="!font-bold !leading-[120%] !border-secondary-800 !text-primary-0">
                健身方案
              </router-link>
            ...
            <li v-if="role === 'USER'">
              <router-link to="/user/dashboard" @click="closeMobileMenu"
                class="inline-block py-2 text-neutral-300 hover:text-primary-0 transition-all font-medium text-base leading-[150%] border-b-2 border-transparent"
                active-class="!font-bold !leading-[120%] !border-secondary-800 !text-primary-0">
                會員介面
              </router-link>
            ...
            <li v-if="role === 'COACH'">
              <router-link to="/coach/profile" @click="closeMobileMenu"
                class="inline-block py-2 text-neutral-300 hover:text-primary-0 transition-all font-medium text-base leading-[150%] border-b-2 border-transparent"
                active-class="!font-bold !leading-[120%] !border-secondary-800 !text-primary-0">
                教練介面
              </router-link>
            ...
            <li v-if="name">
              <button @click="closeMobileMenu(), logout()"
